        ...
        <div class="col-lg-12">
              ...
              <div class="card top-selling">
                ...
                <div class="card-body pb-0">
                  <form method="post" action="<?php echo e(route('search.date')); ?>">
                    <?php echo csrf_field(); ?>
                  <h5 class="card-title">Total Sales Report <span><input type="date" id="date" name="date">
  <input type="submit"></span></h5>
</form>
<img src="img/logo.png" alt="" style="width:10%;">
                  <h3 style="text-align:center;"> Total Sales Report on <?php echo e($date); ?></h3>
    ...
    <a class="btn btn-primary" href="<?php echo e(route('monthlysales')); ?>">Monthly sales Report</a>
  </main><!-- End #main -->
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/admindailyreport.blade.php ENDPATH**/ ?>