 ...
 <header id="header" class="header fixed-top d-flex align-items-center">
		...
		<ul>
          ...
          <!-- <div class="card"> -->
            ...
            <div class="card-body">
              ...
              <a class="btn btn-success" href="<?php echo e(route('stafforder.create')); ?>"> Create order</a>
  ...
  <?php endif; ?>
           ...
           <td> <?php echo e($order->phoneno); ?> </td>
            ...
            <a href="<?php echo e(route('stafforder.show', $order->id)); ?>" class="btn btn-info btn-sm"><i class="bi bi-display"></i></a>
                <a href="<?php echo e(route('stafforder.edit', $order->id)); ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                <form action="<?php echo e(route('stafforder.destroy', $order->id)); ?>" method="post" style="display: inline-block">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/staffneworder.blade.php ENDPATH**/ ?>