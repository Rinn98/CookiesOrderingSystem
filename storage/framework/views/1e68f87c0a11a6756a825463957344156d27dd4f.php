					...
					<table class="table">
						...
						<?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<tr>
								...
								<img src="<?php echo e(('/image/'.$item->options->image)); ?>"width="100" height="100">
								</td>
								
								<td><?php echo e($item ->name); ?></td>
								<td>RM<?php echo e($item->price); ?></td>
								<td>
								<?php echo e($item -> qty); ?> 
								</td>
							...
							<tr>
									...
									<td></td>
									<td></td>
									<td><strong>Total:RM <?php echo e(Cart::Total()); ?></strong></td>
									<td><a class="pest_btn" href="<?php echo e(route('paymentcust.index')); ?>">Checkout</a></td>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/cart.blade.php ENDPATH**/ ?>