...
<body>
 ...
 <header id="header" class="header fixed-top d-flex align-items-center">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <!-- <div class="card"> -->
            ...
            <div class="card">
            <div class="card-body">
              <h5 class="card-title">Staff Order</h5>
  ...
  <?php endif; ?>
                ...
                <td> <?php echo e($order->staffname); ?> </td>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/staffstafforder.blade.php ENDPATH**/ ?>