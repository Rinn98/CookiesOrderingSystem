...
<p>
  ...
  <p>
  <p>
  <form method="post" action="<?php echo e(route('searchdate')); ?>">
                    <?php echo csrf_field(); ?>
                  <h5 class="card-title">Total Profit Report <span><input type="date" id="date" name="startdate"> to <input type="date" id="date" name="enddate">
  <input type="submit"></span></h5>
</form>
<img src="img/logo.png" alt="" style="width:10%;">

  <h3 style="text-align:center;"> Total Profit Report on <?php echo e($startdate); ?> to <?php echo e($enddate); ?> </h3>
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <td>RM <?php echo e($totalsales); ?></td>
                        </tr>
                       
                        <tr>
                        <th scope="col">Total Expenses</th>
                        <td>RM <?php echo e($totalexpenses); ?></td>
                      </tr>
                        
                        <tr>
                        <th scope="col">Shipping</th>
                        <td>RM <?php echo e($shipping); ?></td>
                      </tr>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/adminprofitreport.blade.php ENDPATH**/ ?>