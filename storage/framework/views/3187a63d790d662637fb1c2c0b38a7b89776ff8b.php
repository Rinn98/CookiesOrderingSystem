    ...
    <body>
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<ul class="navbar-nav justify-content-end">
								<li class="dropdown submenu">
									<a class="dropdown-toggle"  href="<?php echo e(route('login')); ?>" role="button" aria-haspopup="true" aria-expanded="false">Login</a>
									
								</li>
                                <li class="dropdown submenu">
									<a class="dropdown-toggle"  href="<?php echo e(url('stafflogin')); ?>" role="button" aria-haspopup="true" aria-expanded="false">Login Staff</a>
									
								</li>
								<li class="dropdown submenu">
									<a class="dropdown-toggle"  href="<?php echo e(route('register-user')); ?>" role="button" aria-haspopup="true" aria-expanded="false">Register</a>
                ...
                <ul>
                    ...
                    <img src="img/home-slider/slider-1.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                        ...
                        <div class="slider_text_box">
                            ...
                            data-textAlign="['left','left','left','left']">Quality Cookies ... <br /> with sweet, delicious</div>
        ...
        <div class="cake_feature_inner">
        			<div class="main_title">
						<h2>Our Featured Cookies</h2>
					</div>
       				<div class="cake_feature_slider owl-carousel">
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="img/cake-feature/c-feature-1.jpg" alt="" width="200" height ="200" >
       							</div>
       							<div class="cake_text">
       								<h4>RM20</h4>
       								<h3>Red Velvet Cookies</h3>
       								<a class="pest_btn"onclick="return confirm('please login')" href="#">Order Now</a>
       							</div>
       						</div>
       					</div>
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="img/cake-feature/c-feature-2.jpg" alt="" width="200" height ="200">
       							</div>
       							<div class="cake_text">
       								<h4>RM20</h4>
       					...
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="img/cake-feature/c-feature-3.jpg" alt="" width="200" height ="200">
       							</div>
       							<div class="cake_text">
       								<h4>RM25</h4>
       								<h3>M&M Cookies</h3>
       					...
       					<div class="item">
       						<div class="cake_feature_item">
       							<div class="cake_img">
       								<img src="img/cake-feature/c-feature-4.jpg" alt="" width="200" height ="200">
       							</div>
       							<div class="cake_text">
       								<h4>RM30</h4>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/homepage.blade.php ENDPATH**/ ?>