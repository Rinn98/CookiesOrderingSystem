...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <?php endif; ?>
              <form class="row g-3" form method="post" action="<?php echo e(route('adminstock.store')); ?>">
                <div class="col-12">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/adminaddstock.blade.php ENDPATH**/ ?>