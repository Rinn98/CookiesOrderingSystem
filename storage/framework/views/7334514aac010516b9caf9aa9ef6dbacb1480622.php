...
<main id="main" class="main">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-success" href="<?php echo e(url('staffregistration')); ?>"> Register Staff</a>
  ...
  <?php endif; ?>
            ...
            <td><?php echo e($staff->city); ?></td>
            <td><?php echo e($staff->postcode); ?></td>
            <td><?php echo e($staff->phoneno); ?></td>
            
        
            <td class="text-center">
                <a href="<?php echo e(route('staff.edit', $staff->id)); ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                <form action="<?php echo e(route('staff.destroy', $staff->id)); ?>" method="post" style="display: inline-block">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/adminmanagestaff.blade.php ENDPATH**/ ?>