...
<!-- End Search Bar -->
 ...
 <tr>
   ...
   <td>  <img src="/image/<?php echo e($order->paymentInvoice); ?>" width="300px"></td> 
 </tr>
 <tr>
...
<p>
  <p>
        ...
        <div class="pull-left">
                <a class="btn btn-primary" href="<?php echo e(route('staffpayment.index')); ?>" title="Go back"> <i class="fas fa-backward "></i>Back </a>
            </div>
    </div>
                </div>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/staffviewpayment.blade.php ENDPATH**/ ?>