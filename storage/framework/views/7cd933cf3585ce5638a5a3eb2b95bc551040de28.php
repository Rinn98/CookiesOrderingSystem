          ...
          <div class="col-lg-12">
            ...
            <table class="table table-borderless datatable">
                      ...
                      <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td> <?php echo e($order->paymentInvoice); ?> </td>
                        <td> <?php echo e($order->quantity); ?> </td>
                        <td> <?php echo e($order->total); ?> </td>
                        <td> <?php echo e($order->paymentMethod); ?> </td>
                        <td class="text-center">
                        <a href="<?php echo e(route('staffpayment.show', $order->id)); ?>" class="btn btn-info btn-sm"><i class="bi bi-display"></i></a></td>
                        </tr>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/staffpayment.blade.php ENDPATH**/ ?>