        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3"  form method="post" action="<?php echo e(route('stafforder.store')); ?>">
              <?php echo csrf_field(); ?>
              <div class="col-12">
...
</html>       <?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/staffaddorder.blade.php ENDPATH**/ ?>