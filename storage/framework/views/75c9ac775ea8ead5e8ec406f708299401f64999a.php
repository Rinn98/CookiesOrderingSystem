        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3"  form method="post" action="<?php echo e(route('adminorder.store')); ?>">
              <?php echo csrf_field(); ?>
              <div class="col-12">
                  ...
                  <div class="col-sm-12">
                    ...
                    <?php $__currentLoopData = $stock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($stock->description); ?>"><?php echo e($stock->description); ?></option>
                ...
                <div class="col-12">
                  ...
                  <div class="col-sm-12">
                    ...
                    <?php $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stocks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($stocks->price); ?>"><?php echo e($stocks->price); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/adminaddorder.blade.php ENDPATH**/ ?>