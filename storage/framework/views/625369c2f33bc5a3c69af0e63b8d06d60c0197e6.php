...
<td>    <p> <img src="/image/<?php echo e($order->paymentInvoice); ?>" width="300px"></td>
    ...
    <div class="pull-left">
            <a class="btn btn-primary" href="<?php echo e(route('stafforder.index')); ?>" title="Go back"> <i class="fas fa-backward "></i>Back </a>
        </div>
</div>
            </div>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/staffvieworder.blade.php ENDPATH**/ ?>