...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Cookies Stock</h5>
    ...
    <?php endif; ?>
              <form class="row g-3" method="post" action="<?php echo e(route('adminstock.update', $stock->id)); ?>" enctype="multipart/form-data">
                <div class="col-12">
                <?php echo csrf_field(); ?>
              <?php echo method_field('PATCH'); ?>
                  <label for="nameofcookies" class="form-label">Description</label>
                  <input type="text" class="form-control" name="description" value="<?php echo e($stock->description); ?>">
                </div>
                <div class="col-12">
                  <label for="price" class="form-label">Image</label>
                  <input type="file" class="form-control" name="image" value="<?php echo e($stock->image); ?>">
                  <img src="/image/<?php echo e($stock->image); ?>" width="100px">
                </div>
                <div class="col-12">
                  <label for="price" class="form-label">Selling Price</label>
                  <input type="text" class="form-control" name="price" value="<?php echo e($stock->price); ?>">
                </div>
                <div class="col-12">
                  <label for="price" class="form-label">Cost Price</label>
                  <input type="text" class="form-control" name="cost" value="<?php echo e($stock->cost); ?>">
                </div>
                <div class="col-12">
                  <label for="quantityofstock" class="form-label">Quantity Available</label>
                  <input type="text" class="form-control" name="quantity" value="<?php echo e($stock->quantity); ?>">
                </div>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/admineditstock.blade.php ENDPATH**/ ?>