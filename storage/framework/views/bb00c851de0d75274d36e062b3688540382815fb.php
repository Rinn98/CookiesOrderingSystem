...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    <?php endif; ?>
              <!-- Vertical Form -->
              <form class="row g-3" method="post" action="<?php echo e(route('adminorder.update', $order->id)); ?>">
              <?php echo csrf_field(); ?>
              <?php echo method_field('PATCH'); ?>
              <div class="col-12">
                  <label class="col-sm-2 col-form-label">Status</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="status" name="status"value="<?php echo e($order->status); ?>" >
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="item"  value="<?php echo e($order->item); ?>" readonly>
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">Quantity</label>
                  <input type="text" class="form-control" name="quantity" value="<?php echo e($order->quantity); ?>" readonly>
                </div>
				 <div class="col-12">
                  <label for="inputEmail4" class="form-label">Price</label>
                  <input type="text" class="form-control" name="price"value="<?php echo e($order->price); ?>" readonly>
                </div>
				 <div class="col-12">
                  <label for="inputEmail4" class="form-label">Total</label>
                  <input type="text" class="form-control" name="total"value="<?php echo e($order->total); ?>" readonly>
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">Customer Name</label>
                  <input type="text" class="form-control" name="name"value="<?php echo e($order->name); ?>" readonly>
                </div>
				 <div class="col-12">
                  <label for="inputEmail4" class="form-label">Address</label>
                  <input type="text" class="form-control" name="address"value="<?php echo e($order->address); ?>" readonly>
                </div>
				 <div class="col-12">
                  <label for="inputEmail4" class="form-label">City</label>
                  <input type="text" class="form-control" name="city"value="<?php echo e($order->city); ?>" readonly>
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">State</label>
                  <input type="text" class="form-control" name="state"value="<?php echo e($order->state); ?>" readonly>
                </div>
				<div class="col-12">
                  <label for="inputPassword4" class="form-label">Postcode</label>
                  <input type="text" class="form-control" name="postcode"value="<?php echo e($order->postcode); ?>" readonly>
                </div>
				<div class="col-12">
                  <label for="inputPassword4" class="form-label">Email</label>
                  <input type="text" class="form-control" name="email"value="<?php echo e($order->email); ?>" readonly>
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">Phone Number</label>
                  <input type="text" class="form-control" name="phoneno"value="<?php echo e($order->phoneno); ?>" readonly>
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">Payment Invoice</label>
                 <p> <input type="file" id="filename" name="paymentInvoice"value="<?php echo e($order->paymentInvoice); ?>" readonly>
                 <img src="/image/<?php echo e($order->paymentInvoice); ?>" width="100px">
                </div>
                <div class="col-12">
                  <label class="col-sm-2 col-form-label">Delivery Method</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="delivery" name="delivery"value="<?php echo e($order->delivery); ?>" >
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" name="remarks" id="remarks" rows="1" placeholder="Note about your order" value="<?php echo e($order->remarks); ?>" readonly></textarea>
                </div>
                <div class="col-12">
                  <label class="col-sm-2 col-form-label">Payment Method</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="PaymentMethod" name="PaymentMethod"value="<?php echo e($order->PaymentMethod); ?>" >
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/admineditorder.blade.php ENDPATH**/ ?>