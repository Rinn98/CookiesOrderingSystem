...
<li class="nav-item">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Cookies Stock</h5>
              
              <a class="btn btn-success" href="<?php echo e(route('adminstock.create')); ?>"> Create stock</a>
  ...
  <?php endif; ?>
            ...
            <td><img src="/image/<?php echo e($stock->image); ?>" width="100px"></td>
            <td><?php echo e($stock->price); ?></td>
            <td><?php echo e($stock->cost); ?></td>
            <td><?php echo e($stock->quantity); ?></td>
        
            <td class="text-center">
                <a href="<?php echo e(route('adminstock.edit', $stock->id)); ?>" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                <form action="<?php echo e(route('adminstock.destroy', $stock->id)); ?>" method="post" style="display: inline-block">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/adminstock.blade.php ENDPATH**/ ?>