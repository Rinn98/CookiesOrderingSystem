...
<main id="main" class="main">
  ...
  <tr>
    ...
    <td>  <?php echo e($order->staff_id); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>    <p> <img src="/image/<?php echo e($order->paymentInvoice); ?>" width="300px"></td>
  </tr>
</table>
        ...
        <div class="pull-left">
                <a class="btn btn-primary" href="<?php echo e(route('adminorder.index')); ?>" title="Go back"> <i class="fas fa-backward "></i>Back </a>
            </div>
    </div>
                </div>
...
</html><?php /**PATH C:\laragon\www\Cookies\resources\views/FrontEnd/adminvieworder.blade.php ENDPATH**/ ?>