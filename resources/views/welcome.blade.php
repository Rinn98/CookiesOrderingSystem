						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<ul class="navbar-nav justify-content-end">
								<li class="dropdown submenu">
									<a class="dropdown-toggle"  href="{{ route('login') }}" role="button" aria-haspopup="true" aria-expanded="false">Login</a>
									
								</li>
                                <ul class="navbar-nav justify-content-end">
								<li class="dropdown submenu">
									<a class="dropdown-toggle"  href="{{ route('stafflogin') }}" role="button" aria-haspopup="true" aria-expanded="false">Staff Login</a>
									
								</li>
								<li class="dropdown submenu">
									<a class="dropdown-toggle"  href="{{ route('register-user') }}" role="button" aria-haspopup="true" aria-expanded="false">Register</a>
