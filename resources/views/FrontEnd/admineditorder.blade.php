...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    @endif
              <!-- Vertical Form -->
              <form class="row g-3" method="post" action="{{ route('adminorder.update', $order->id) }}">
              @csrf
              @method('PATCH')
              <div class="col-12">
                ...
                <div class="col-12">
                 ...
                 <p> <input type="file" id="filename" name="paymentInvoice"value="{{ $order->paymentInvoice }}" readonly>
                 <img src="/image/{{$order->paymentInvoice }}" width="100px">
                </div>
                <div class="col-12">
                  <label class="col-sm-2 col-form-label">Delivery Method</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="delivery" name="delivery"value="{{ $order->delivery }}" >
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" name="remarks" id="remarks" rows="1" placeholder="Note about your order" value="{{ $order->remarks }}" readonly></textarea>
                </div>
                <div class="col-12">
                  <label class="col-sm-2 col-form-label">Payment Method</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="PaymentMethod" name="PaymentMethod"value="{{ $order->PaymentMethod }}" >
