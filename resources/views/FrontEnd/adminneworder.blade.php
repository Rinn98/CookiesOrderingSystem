...
<main id="main" class="main">
        ...
        <div class="col-lg-12">
          ...
          <!-- <div class="card"> -->
            ...
            <div class="card-body">
              ...
              <a class="btn btn-success" href="{{ route('adminorder.create') }}"> Create order</a>
  ...
  @endif
           ...
           <td> {{$order->phoneno}} </td>
            ...
            <a href="{{ route('adminorder.show', $order->id)}}" class="btn btn-info btn-sm"><i class="bi bi-display"></i></a>
                <a href="{{ route('adminorder.edit', $order->id)}}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                <form action="{{ route('adminorder.destroy', $order->id)}}" method="post" style="display: inline-block">
                    @csrf
                    @method('DELETE')
