...
<!-- End Search Bar -->
 ...
 <tr>
   ...
   <td>  <img src="/image/{{ $order->paymentInvoice }}" width="300px"></td> 
 </tr>
 <tr>
...
<p>
  <p>
        ...
        <div class="pull-left">
                <a class="btn btn-primary" href="{{ route('staffpayment.index') }}" title="Go back"> <i class="fas fa-backward "></i>Back </a>
            </div>
    </div>
                </div>
