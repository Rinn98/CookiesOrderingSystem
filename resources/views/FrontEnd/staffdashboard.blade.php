...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        Welcome {{ \Auth::guard('staff')->user()->username }} Staff
       ...
       <!-- End Notification Nav -->
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="{{ route('signout') }}" >
            
            <span class="d-none d-md-block "  href="{{ route('signout') }}">Logout</span>
