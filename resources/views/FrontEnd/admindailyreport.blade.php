...
<img src="img/logo.png" alt="" style="width:10%;">
                  <h3 style="text-align:center;"> Total Sales Report on {{$date}}</h3>
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                         <th colspan="4">Total Sales</th><th>RM {{$total}}</th> </tr>  
    ...
    <a class="btn btn-primary" href="{{ route('monthlysales') }}">Monthly sales Report</a>
  </main><!-- End #main -->
