                ...
                <div class="row">
                	<div class="col-lg-7">
                		...
                		<div class="billing_form_area">
                			<form class="billing_form row" action="{{ route('paymentcust.store') }}" method="POST" id="contactForm" novalidate="novalidate">
							@csrf
								<div class="form-group col-md-12">
								    <label for="first"> Name *</label>
									<input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{Auth::user()->name}}" readonly>
								</div>
								
								<div class="form-group col-md-12">
								    <label for="address">Address *</label>
									<input type="text" class="form-control" id="address" name="address" placeholder="Street Address" value="{{Auth::user()->address}}" >
								</div>
								<div class="form-group col-md-12">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" id="postcode" name="postcode" placeholder="Postcode / Zip" value="{{Auth::user()->postcode}}" >
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" id="phoneno" name="phoneno" placeholder="Select an option" value="{{Auth::user()->phoneno}}" >
								</div>
								<div class="form-group col-md-12">
                		...
                		<div class="order_box_price">
							...
							<div class="payment_list">
								<div class="price_single_cost">
									...
									<h5>{{$item->name}} x {{$item->qty}} <span>RM {{$item-> price}}</span></h5>
									<h5>Delivery/Postage Charge <span>RM 5</span></h5>
									@endforeach
									<h3>Total <span>RM {{Cart::total()+5}}</span></h3>
