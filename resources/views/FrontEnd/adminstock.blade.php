...
<li class="nav-item">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-success" href="{{ route('adminstock.create') }}"> Create stock</a>
  ...
  @endif
            ...
            <td><img src="/image/{{ $stock->image }}" width="100px"></td>
            <td>{{$stock->price}}</td>
            <td>{{$stock->cost}}</td>
            <td>{{$stock->quantity}}</td>
        
            <td class="text-center">
                <a href="{{ route('adminstock.edit', $stock->id)}}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
                <form action="{{ route('adminstock.destroy', $stock->id)}}" method="post" style="display: inline-block">
                    @csrf
                    @method('DELETE')
