...
<main id="main" class="main">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-success" href="{{url('staffregistration')}}"> Register Staff</a>
  ...
  @endif
            ...
            <td class="text-center">
                <a href="{{ route('staff.edit', $staff->id)}}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
