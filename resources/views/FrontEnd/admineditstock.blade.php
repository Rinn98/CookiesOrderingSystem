...
<li class="nav-item">
  ...
  <main id="main" class="main">
    ...
    @endif
              <form class="row g-3" method="post" action="{{ route('adminstock.update', $stock->id) }}" enctype="multipart/form-data">
                <div class="col-12">
                @csrf
              @method('PATCH')
                ...
                <div class="col-12">
                  ...
                  <input type="file" class="form-control" name="image" value="{{ $stock->image }}">
                  <img src="/image/{{ $stock->image }}" width="100px">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="cost" value="{{ $stock->cost }}">
                </div>
                <div class="col-12">
