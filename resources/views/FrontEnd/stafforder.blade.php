    ...
    <div class="col-lg-12">
      ...
      <!-- <div class="card"> -->
        ...
        <div class="card-body">
          ...
          <a class="btn btn-success" href="{{ route('stafforder.create') }}"> Create order</a>
          <td><a href="{{ route('send')}}" class="btn btn-dark btn">Send Email</a></td>
	...
	<div class="alert alert-danger">
      ...
      <table class="table table-borderless datatable ">
       ...
       <td> {{$order->phoneno}} </td>
        ...
        <a href="{{ route('stafforder.show', $order->id)}}" class="btn btn-info btn-sm"><i class="bi bi-display"></i></a>
            <a href="{{ route('stafforder.edit', $order->id)}}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i></a>
            <form action="{{ route('stafforder.destroy', $order->id)}}" method="post" style="display: inline-block">
                @csrf
                @method('DELETE')
